...
class City:
    def __init__(self, name, country):
        ...
        self.config.read(os.path.dirname(__file__)+'/city.ini')
        
        self.name = name
        self.country = country
        self.valid_country = self.check_country(country)
    ...
    def get_coordinates(self):
        ...
        apiurl = self.apiurl + '?q=' + str(self.name) + ", " + self.country + '&api_key=' + self.apikey
        req = requests.get(apiurl)
        resp = req.json()
        if len(resp) > 0:
            citydata = resp[0]
            if 'lat' in citydata and 'lon' in citydata:
